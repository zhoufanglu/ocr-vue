<template>
  <div class="edit-anchor-zone">
    <div class="edit-toolbar">
      ...
      <span class="toolbar-icon-wrap" :class="{'icon_active': isTableActive}">
        <el-tooltip class="item" effect="light" content="框选列表" placement="top">
          <el-button  @click="drawTable">框选列表</el-button>
        </el-tooltip>
      </span>
      ...
      <span class="toolbar-icon-wrap" :class="{'icon_active': isAdaptDrawActive}">
        <el-tooltip class="item" effect="light" content="适应画布" placement="top">
          <el-button @click="adaptDraw">适应画布</el-button>
        </el-tooltip>
      </span>
    ...
    <el-dialog title="请选择分割列数" :visible.sync="tableVisible" width="30%">
      <div class="select-wrapper">
        ...
        <el-button @click="tableVisible = false">确定</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    drawCanvas(moveX = 0, moveY = 0) {
      ...
      /*console.log((this.drawWidth - width) / 2)
      console.log((this.drawHeight - height) / 2)*/
